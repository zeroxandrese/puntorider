...
import { tripPostService, tripPutService, tripDeleteService, tripGetService } from '../services/tripService';
...
export { tripPostController, tripPutController, tripDeleteController, tripGetController };